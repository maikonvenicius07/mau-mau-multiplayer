...
const tracks=['tela_inicial_instrumental.mp3','lobby_mesa_aberta.mp3','mesa_de_mau_mau_a.mp3','mesa_de_mau_mau_b.mp3','rock_candeias.mp3','ultima_carta.mp3','conferencia_rodada.mp3','vitoria_rodada.mp3','campeao_partida.mp3'];
...
ok(js.includes("if(!state)return 'landingUser'"),'instrumental exclusivo da tela inicial não integrado');
ok(js.includes("landingUser:{file:'/assets/music/tela_inicial_instrumental.mp3'"),'faixa instrumental da tela inicial ausente no catálogo');
