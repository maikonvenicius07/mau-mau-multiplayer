...
assert(pkg.version==='40.53.0','package.json deve identificar V40.53');
...
console.log(`✓ V40.53: state leve confirmado (${rawJson.length} -> ${leanJson.length} caracteres no cenário sintético).`);
