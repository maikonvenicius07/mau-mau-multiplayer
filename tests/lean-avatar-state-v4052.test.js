...
assert(pkg.version==='40.52.0','package.json deve identificar V40.52');
...
console.log(`✓ V40.52: state leve confirmado (${rawJson.length} -> ${leanJson.length} caracteres no cenário sintético).`);
