...
assert.strictEqual(pkg.version,'40.66','package.json deve identificar V40.66');
...
(async()=>{
  ...
  console.log('✓ V40.66: /ready prova PostgreSQL ativo, Render exige banco e /health continua apenas como liveness.');
