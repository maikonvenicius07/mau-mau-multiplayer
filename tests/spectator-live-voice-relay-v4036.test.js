...
assert(!app.includes("if(isSpectatorState()||peer?.role==='SPECTATOR')return"),'V40.52 ainda bloqueia WebRTC para observador');
...
console.log('✓ V40.52: observadores usam WebRTC/Opus primeiro e relay leve somente como fallback seletivo.');
