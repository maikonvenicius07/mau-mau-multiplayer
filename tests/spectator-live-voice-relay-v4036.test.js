...
assert.strictEqual(pkg.version,'40.36.0');
assert(app.includes('LIVE_VOICE_RELAY_SAMPLE_RATE=16000'),'relay deve usar PCM mono 16 kHz');
assert(app.includes("socket.emit('liveVoiceRelayPcm'"),'cliente não envia PCM de compatibilidade');
...
console.log('✓ V40.36: voz envolvendo observador usa relay PCM pelo servidor, sem depender de P2P/TURN.');
