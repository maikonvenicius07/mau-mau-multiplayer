...
assert(render.includes('npm run verify'),'Render deve testar antes de publicar');
assert(render.includes('npm ci --no-audit --no-fund'),'Render deve usar npm ci quando houver lockfile');
