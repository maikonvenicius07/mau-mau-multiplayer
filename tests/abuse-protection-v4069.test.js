...
assert.strictEqual(pkg.version,'40.69','package.json deve identificar V40.69');
assert.strictEqual(Gov.DEFAULT_MAX_ROOMS,10,'V40.69 deve usar 10 salas por padrão');
assert.strictEqual(Abuse.DEFAULT_MAX_SPECTATORS_PER_ROOM,5,'V40.69 deve usar 5 observadores por sala');
...
console.log('✓ V40.69: 10 salas, 5 observadores, rate limit e códigos criptograficamente seguros validados.');
