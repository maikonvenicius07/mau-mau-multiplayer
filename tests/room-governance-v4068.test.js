...
assert.strictEqual(pkg.version,'40.69.2','package.json deve identificar V40.68');
...
console.log('✓ V40.68/V40.69.2: limite de 10 salas, reserva concorrente, auditoria e diagnóstico de limpeza validados.');
