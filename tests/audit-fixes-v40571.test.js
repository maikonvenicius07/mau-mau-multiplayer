...
assert.strictEqual(pkg.version,'40.65');
assert(html.includes('app.js?v=40.65')&&html.includes('styles.css?v=40.65'),'cache-busting V40.58.4 ausente');
...
console.log('✓ V40.62: deploy restaurado, socket substituído encerrado e partida ativa preservada sem limite de 6 h.');
