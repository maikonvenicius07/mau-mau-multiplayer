...
assert(html.includes('app.js?v=40.58.5')&&html.includes('styles.css?v=40.58.5'),'cache-busting V40.58.4 ausente');
...
console.log('✓ V40.58.5: deploy restaurado, socket substituído encerrado e partida ativa preservada sem limite de 6 h.');
