...
assert(html.includes('app.js?v=40.59.0')&&html.includes('styles.css?v=40.59.0'),'cache-busting V40.58.4 ausente');
...
console.log('✓ V40.59.0: deploy restaurado, socket substituído encerrado e partida ativa preservada sem limite de 6 h.');
