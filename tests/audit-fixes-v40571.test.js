...
assert.strictEqual(pkg.version,'40.58.1');
assert(html.includes('app.js?v=40.58.1')&&html.includes('styles.css?v=40.58.1'),'cache-busting V40.58.1 ausente');
...
console.log('✓ V40.58.1: deploy restaurado, socket substituído encerrado e partida ativa preservada sem limite de 6 h.');
