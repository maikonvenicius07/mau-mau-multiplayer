...
assert(!fs.existsSync(musicDir),'public/assets/music ainda existe; a V40.54 deve continuar sem trilhas internas');
...
assert(html.includes('app.js?v=40.58.2')&&html.includes('styles.css?v=40.58.2'),'cache-busting V40.54 ausente');
