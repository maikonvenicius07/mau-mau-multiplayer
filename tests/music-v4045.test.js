...
assert(!fs.existsSync(musicDir),'public/assets/music ainda existe; a V40.51 deve continuar sem trilhas internas');
...
assert(total<2500000,`public ainda está pesado demais para V40.51: ${total} bytes`);
const html=fs.readFileSync(path.join(publicDir,'index.html'),'utf8');
assert(html.includes('app.js?v=40.51')&&html.includes('styles.css?v=40.51'),'cache-busting V40.51 ausente');
console.log(`✓ V40.51: sem assets de música interna; public=${total} bytes.`);
