...
assert.strictEqual(pkg.version,'40.61.1','package.json deve identificar a V40.50');
const html=read('public/index.html');
assert(html.includes('app.js?v=40.61.1'),'index deve usar cache-busting V40.50 para app.js');
assert(html.includes('styles.css?v=40.61.1'),'index deve usar cache-busting V40.50 para styles.css');
