...
**Front-end oficial:** `public/index.html`, `public/app.js` e `public/styles.css`. Os antigos duplicados da raiz foram removidos para evitar atualização no arquivo errado.
